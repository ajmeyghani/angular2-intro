System.register(['angular2/core', 'angular2/platform/browser', './unit.pipe', './round.pipe'], function(exports_1) {
    ...
    var core_1, browser_1, unit_pipe_1, round_pipe_1;
    ...
    return {
        setters:[
            ...
            function (unit_pipe_1_1) {
                unit_pipe_1 = unit_pipe_1_1;
            },
        ...
        execute: function() {
            ...
            BasicPipeExample = (function () {
                ...
                BasicPipeExample = __decorate([
                    core_1.Component({
                        selector: 'app',
                        pipes: [unit_pipe_1.UnitPipe, round_pipe_1.RoundPipe],
